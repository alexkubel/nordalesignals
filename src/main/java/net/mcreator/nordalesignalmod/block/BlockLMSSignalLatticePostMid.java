...
public class BlockLMSSignalLatticePostMid extends ElementsNordalesignalmodMod.ModElement {
	@GameRegistry.ObjectHolder("nordalesignalmod:lms_signal_lattice_post_mid")
	public static final Block block = null;
	public BlockLMSSignalLatticePostMid(ElementsNordalesignalmodMod instance) {
		super(instance, 50);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("lms_signal_lattice_post_mid"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("nordalesignalmod:lms_signal_lattice_post_mid", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockHorizontal.FACING;
		public BlockCustom() {
			super(Material.IRON);
			setUnlocalizedName("lms_signal_lattice_post_mid");
