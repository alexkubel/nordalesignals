...
public class BlockLMSSignalWoodPostBlackplateMid extends ElementsNordalesignalmodMod.ModElement {
	@GameRegistry.ObjectHolder("nordalesignalmod:lms_signal_wood_post_blackplate_mid")
	public static final Block block = null;
	public BlockLMSSignalWoodPostBlackplateMid(ElementsNordalesignalmodMod instance) {
		super(instance, 57);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("lms_signal_wood_post_blackplate_mid"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("nordalesignalmod:lms_signal_wood_post_blackplate_mid", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockHorizontal.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("lms_signal_wood_post_blackplate_mid");
		...
		public void addInformation(ItemStack itemstack, World world, List<String> list, ITooltipFlag flag) {
			...
			list.add("Middle Wooden Post with Backplate");
		}
