...
public class BlockLMSSignalLatticeRule55Plate extends ElementsNordalesignalmodMod.ModElement {
	@GameRegistry.ObjectHolder("nordalesignalmod:lms_signal_lattice_rule_55_plate")
	public static final Block block = null;
	public BlockLMSSignalLatticeRule55Plate(ElementsNordalesignalmodMod instance) {
		super(instance, 68);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("lms_signal_lattice_rule_55_plate"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("nordalesignalmod:lms_signal_lattice_rule_55_plate", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockHorizontal.FACING;
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("lms_signal_lattice_rule_55_plate");
