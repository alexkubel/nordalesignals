 ...
 *
 *    Keep the ElementsNordalesignalmodMod object in this class and all calls to this object
...
public class NordalesignalmodMod {
	...
	@Mod.Instance(MODID)
	public static NordalesignalmodMod instance;
	public ElementsNordalesignalmodMod elements = new ElementsNordalesignalmodMod();
	@Mod.EventHandler
	public void preInit(FMLPreInitializationEvent event) {
		MinecraftForge.EVENT_BUS.register(this);
		GameRegistry.registerWorldGenerator(elements, 5);
		GameRegistry.registerFuelHandler(elements);
		NetworkRegistry.INSTANCE.registerGuiHandler(this, new ElementsNordalesignalmodMod.GuiHandler());
