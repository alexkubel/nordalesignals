...
public class ProcedureSignalPull8 extends ElementsNordalesignalmodMod.ModElement {
	public ProcedureSignalPull8(ElementsNordalesignalmodMod instance) {
		super(instance, 79);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure SignalPull8!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure SignalPull8!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure SignalPull8!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure SignalPull8!");
			return;
		}
		...
		if ((new Object() {
		...
		}.getValue(new BlockPos((int) x, (int) y, (int) z), "Lever8"))) {
			while (((i) <= 32)) {
				locX = (int) ((new Object() {
			...
			if (!world.isRemote) {
				...
				if (_tileEntity != null)
					_tileEntity.getTileData().setBoolean("Lever8", (true));
			...
			if (!world.isRemote) {
				...
				IBlockState _bs = world.getBlockState(_bp);
				if (_tileEntity != null)
					_tileEntity.getTileData().setBoolean("Lever8", (false));
				world.notifyBlockUpdate(_bp, _bs, _bs, 3);
			}
		}
	}
