...
public class ProcedureSignalPull6 extends ElementsNordalesignalmodMod.ModElement {
	public ProcedureSignalPull6(ElementsNordalesignalmodMod instance) {
		super(instance, 77);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure SignalPull6!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure SignalPull6!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure SignalPull6!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure SignalPull6!");
			return;
		}
		...
		if ((new Object() {
		...
		}.getValue(new BlockPos((int) x, (int) y, (int) z), "Lever6"))) {
			while (((i) <= 24)) {
				locX = (int) ((new Object() {
			...
			if (!world.isRemote) {
				...
				if (_tileEntity != null)
					_tileEntity.getTileData().setBoolean("Lever6", (true));
			...
			if (!world.isRemote) {
				...
				IBlockState _bs = world.getBlockState(_bp);
				if (_tileEntity != null)
					_tileEntity.getTileData().setBoolean("Lever6", (false));
				world.notifyBlockUpdate(_bp, _bs, _bs, 3);
			}
		}
	}
