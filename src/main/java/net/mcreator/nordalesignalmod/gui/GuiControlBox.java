...
public class GuiControlBox extends ElementsNordalesignalmodMod.ModElement {
	public static int GUIID = 2;
	public static HashMap guistate = new HashMap();
	public GuiControlBox(ElementsNordalesignalmodMod instance) {
		super(instance, 22);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 7, 30) {
			}));
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 25, 12) {
			}));
			this.customSlots.put(3, this.addSlotToContainer(new Slot(internal, 3, 25, 30) {
			}));
			this.customSlots.put(4, this.addSlotToContainer(new Slot(internal, 4, 43, 12) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
			}));
			this.customSlots.put(5, this.addSlotToContainer(new Slot(internal, 5, 43, 30) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
			}));
			this.customSlots.put(6, this.addSlotToContainer(new Slot(internal, 6, 61, 12) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
			}));
			this.customSlots.put(7, this.addSlotToContainer(new Slot(internal, 7, 61, 30) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("nordalesignalmod:textures/control_box.png");
		@Override
